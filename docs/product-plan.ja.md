...
現在の CLI は terminal、Slack、Discord、Teams、custom webhook payload、
GitHub PR comment、GitHub Checks summary payload をサポートします。email、
Linear、Jira は staged integration です。
