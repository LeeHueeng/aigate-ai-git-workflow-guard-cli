...
| 채널 | 현재 상태 |
| --- | --- |
| npm | `aigate-cli@0.1.7`가 `latest` dist-tag로 배포됨 |
| GitHub Release | `v0.1.7` 게시 완료 |
| Docker/GHCR | `ghcr.io/leehueeng/aigate-cli:0.1.7`, `latest` 배포 완료 |
| Homebrew | `brew install LeeHueeng/tap/aigate-cli` |
| GitHub Action | `LeeHueeng/aigate-ai-git-workflow-guard-cli@v0.1.7`로 사용 가능, Marketplace 게시 여부는 릴리스 화면에서 수동 확인 |
