...
- [x] Homebrew formula 추가
- [x] `LeeHueeng/homebrew-tap`으로 Homebrew formula publish
- [x] GHCR에 Docker image publish
...
- [x] `aigate start --route default --ask-steps`로 단계별 기본 설정 추가
